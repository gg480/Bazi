...
const BaziAnalyzer = require('../bazi/baziAnalyzer.cjs');
...
class ZiweiAnalyzer {
  ...
  performRealZiweiAnalysis(birth_data) {
    try {
      ...
      const { name, birth_date, birth_time, gender, accurate_lunar_info } = birth_data;
    ...
    // 使用传入的准确农历信息，或回退到本地计算
    const lunarInfo = accurate_lunar_info || this.calculateLunarInfo(birth_date);
  ...
  calculatePreciseBazi(birthDateStr, birthTimeStr) {
    ...
    return {
      ...
      // 添加前端需要的字段
      complete_chart: baziResult.complete_chart,
     ...
     Object.entries(palaceInteractions).forEach(([palaceName, interaction]) => {
       ...
       if (effects.opposite_palace.strength > 0.6) {
         recommendations.push({
           type: '对宫平衡',
           palace: palaceName,
           recommendation: `您需要注意${palaceName}与${effects.opposite_palace.target_palace}的平衡发展`
         });
       }
       ...
       if (effects.triangle_palaces.average_strength > 0.7) {
         recommendations.push({
           type: '三合助力',
           palace: palaceName,
           recommendation: `您可以善用${palaceName}的三合宫位带来的助力`
         });
       }
     });
  ...
  generatePersonalityOverview(personName, position, mainStars, mainStar, personGender) {
    ...
    return ` 您的命宫坐落在${position}，主星为${starCombination}。${positionInfluence}这样的星曜组合使您${this.getStarCombinationPersonality(mainStars, personName)}，同时${genderModifier}。您的人生格局${this.getLifePatternDescription(mainStar, personName)}。`;
  }
  ...
  analyzeDeepPersonalityTraits(mainStars, luckyStars, unluckyStars, personName, personGender) {
   ...
   getStarCoreTraits(star, personName, personGender) {
     ...
     const starTraits = {
       '紫微': ` 您具有天生的领导魅力和高贵气质。${genderPrefix}，您展现出强烈的责任感和使命感，喜欢在团队中担任核心角色，但有时可能过于在意他人的看法`,
       '天机': ` 您的思维极其敏捷，善于洞察事物的本质。${genderPrefix}，您具有很强的策划能力和应变能力，但有时可能因为想得太多而错失行动的最佳时机`,
       '太阳': ` 您如太阳般光明磊落，具有强烈的正义感。${genderPrefix}，您天生具有感染他人的能力，喜欢帮助他人，但要注意不要过度消耗自己的能量`,
       '武曲': ` 您意志坚强，执行力超群。${genderPrefix}，您具有很强的目标导向性和实现能力，在财务管理方面有天赋，但要学会在坚持中保持灵活`,
       '天同': ` 您性格温和，具有很强的亲和力。${genderPrefix}，您善于营造和谐的氛围，人际关系良好，但有时可能因为过于随和而缺乏主见`,
       '廉贞': ` 您感情丰富，具有艺术天赋。${genderPrefix}，您追求美好的事物，有很强的审美能力，但情绪波动较大，需要学会情绪管理`,
       '天府': ` 您稳重可靠，是他人的依靠。${genderPrefix}，您善于积累和管理，注重安全感，具有很强的组织能力，但有时可能过于保守`,
       '太阴': ` 您细腻敏感，直觉力强。${genderPrefix}，您善于照顾他人，具有很强的同理心，但有时可能过于敏感，容易受到情绪影响`,
       '贪狼': ` 您多才多艺，充满魅力。${genderPrefix}，您善于交际，适应能力强，喜欢尝试新事物，但要注意专注力的培养`,
       '巨门': ` 您口才出众，分析能力强。${genderPrefix}，您善于发现问题的关键，具有很强的研究精神，但要注意表达方式的温和`,
       '天相': ` 您忠诚可靠，协调能力强。${genderPrefix}，您善于辅助他人，具有很强的服务精神，但要学会在帮助他人的同时也要为自己考虑`,
       '天梁': ` 您正直善良，具有长者风范。${genderPrefix}，您有很强的责任感和正义感，喜欢帮助弱者，但要避免过于严肃`,
       '七杀': ` 您冲劲十足，勇于开拓。${genderPrefix}，您不怕困难，具有很强的开拓精神，但要学会在冲劲中保持理性`,
       '破军': ` 您勇于创新，不满足现状。${genderPrefix}，您具有很强的变革能力，善于突破，但要注意在变化中保持稳定的核心价值`
     };
     
     return starTraits[star] || ` 您具有${star}的独特特质`;
   }
   ...
   getLuckyStarsInfluence(luckyStars, personName) {
     ...
     luckyStars.forEach(star => {
       const starInfluence = {
         '文昌': ` 文昌星的加持使您文思敏捷，学习能力强，在文化艺术方面有特殊天赋`,
         '文曲': ` 文曲星的影响让您口才出众，表达能力强，善于与人沟通交流`,
         '左辅': ` 左辅星的帮助使您容易得到贵人相助，在团队中能发挥重要作用`,
         '右弼': ` 右弼星的支持让您具有很强的协调能力，善于处理人际关系`,
         '天魁': ` 天魁星的庇佑使您容易遇到年长的贵人，在关键时刻得到指导`,
         '天钺': ` 天钺星的照耀让您具有很强的直觉力，能够把握机会`
       };
   ...
   getUnluckyStarsGrowth(unluckyStars, personName) {
     ...
     unluckyStars.forEach(star => {
       const starGrowth = {
         '擎羊': ` 擎羊星虽然带来冲动，但也赋予了您勇往直前的勇气，学会控制冲动就能化阻力为动力`,
         '陀罗': ` 陀罗星可能带来拖延，但也培养了您的耐心和坚持，学会把握节奏就能稳步前进`,
         '火星': ` 火星虽然容易急躁，但也给了您快速行动的能力，学会冷静思考就能事半功倍`,
         '铃星': ` 铃星可能带来波动，但也增强了您的敏感度，学会情绪管理就能化挑战为优势`,
         '地空': ` 地空星虽然可能带来空想，但也赋予了您丰富的想象力，脚踏实地就能实现理想`,
         '地劫': ` 地劫星可能带来变化，但也培养了您的适应能力，学会稳中求变就能化险为夷`
       };
  ...
  generateHealthAdvice(healthStars, personName) { return `您应该保持规律作息，适度运动`; }
  ...
  generateFamilyAdvice(parentsPalace, childrenPalace, personName) { return `您应该珍惜家庭关系，孝顺父母`; }
  
  analyzeCurrentPeriod(currentPeriod, personName) { return `您目前处于${currentPeriod.description}，是重要的发展阶段`; }
  ...
  generateTimingAdvice(currentPeriod, personName) { return `您应该把握当前时机，积极发展`; }
  ...
  generateOverallGuidance(mainStar, personName) { return `您应该发挥${mainStar}星的优势，创造美好人生`; }
  ...
  analyzePersonalizedStrengths(mainStars, luckyStars, personName, personGender) {
    ...
    return strengths.join('；') || ` 您具有独特的个人优势`;
  }
  ...
  getStarStrengths(star, personName, personGender) {
    ...
    const starStrengths = {
      '紫微': ` 您具有天生的领导魅力和组织能力。${genderPrefix}，您能够在团队中发挥核心作用，具有很强的责任感和使命感`,
      '天机': ` 您思维敏捷，善于策划和分析。${genderPrefix}，您具有很强的洞察力和应变能力，能够在复杂情况下找到最佳解决方案`,
      '太阳': ` 您光明磊落，具有很强的正义感。${genderPrefix}，您天生具有感染他人的能力，能够成为他人的榜样和引导者`,
      '武曲': ` 您意志坚强，执行力超群。${genderPrefix}，您具有很强的目标导向性和实现能力，在财务管理方面有天赋`,
      '天同': ` 您性格温和，人际关系和谐。${genderPrefix}，您具有很强的亲和力和包容心，能够营造和谐的氛围`,
      '廉贞': ` 您感情丰富，具有艺术天赋。${genderPrefix}，您追求美好的事物，有很强的审美能力和创造力`,
      '天府': ` 您稳重可靠，善于积累和管理。${genderPrefix}，您注重安全感，具有很强的组织能力和理财天赋`,
      '太阴': ` 您细腻敏感，直觉力强。${genderPrefix}，您善于照顾他人，具有很强的同理心和洞察力`,
      '贪狼': ` 您多才多艺，充满魅力。${genderPrefix}，您善于交际，适应能力强，具有很强的学习能力`,
      '巨门': ` 您口才出众，分析能力强。${genderPrefix}，您善于发现问题的关键，具有很强的研究精神和专业能力`,
      '天相': ` 您忠诚可靠，协调能力强。${genderPrefix}，您善于辅助他人，具有很强的服务精神和团队合作能力`,
      '天梁': ` 您正直善良，具有长者风范。${genderPrefix}，您有很强的责任感和正义感，能够给他人提供指导和帮助`,
      '七杀': ` 您冲劲十足，勇于开拓。${genderPrefix}，您不怕困难，具有很强的开拓精神和执行力`,
      '破军': ` 您勇于创新，不满足现状。${genderPrefix}，您具有很强的变革能力和突破精神，善于在变化中寻找机会`
    };
  ...
  getLuckyStarsBonus(luckyStars, personName) {
    ...
    luckyStars.forEach(star => {
      const starBonus = {
        '文昌': ` 文昌星的加持使您在学习和文化方面有特殊天赋，表达能力强`,
        '文曲': ` 文曲星的影响让您口才出众，善于沟通交流，具有艺术气质`,
        '左辅': ` 左辅星的帮助使您容易得到贵人相助，在团队中能发挥重要作用`,
        '右弼': ` 右弼星的支持让您具有很强的协调能力，善于处理人际关系`,
        '天魁': ` 天魁星的庇佑使您容易遇到年长的贵人，在关键时刻得到指导`,
        '天钺': ` 天钺星的照耀让您具有很强的直觉力，能够把握机会`
  ...
  analyzePersonalizedChallenges(mainStars, unluckyStars, personName, personGender) {
    ...
    return challenges.join('；') || ` 您需要注意平衡发展，避免过度偏向某一方面`;
  }
  ...
  getStarChallenges(star, personName, personGender) {
    ...
    const starChallenges = {
      '紫微': ` 您需要注意不要过于自我中心。${genderPrefix}，要学会倾听他人意见，避免过于强势`,
      '天机': ` 您需要注意不要想得太多而缺乏行动。${genderPrefix}，要学会在思考和行动之间找到平衡`,
      '太阳': ` 您需要注意不要过度消耗自己的能量。${genderPrefix}，要学会适度休息，避免过度付出`,
      '武曲': ` 您需要注意不要过于注重物质而忽视情感。${genderPrefix}，要学会在坚持中保持灵活`,
      '天同': ` 您需要注意不要过于随和而缺乏主见。${genderPrefix}，要学会在适当时候坚持自己的立场`,
      '廉贞': ` 您需要注意情绪管理，避免过度敏感。${genderPrefix}，要学会在感性和理性之间找到平衡`,
      '天府': ` 您需要注意不要过于保守而错失机会。${genderPrefix}，要学会在稳重中保持开放`,
      '太阴': ` 您需要注意不要过于敏感而影响判断。${genderPrefix}，要学会保护自己的情绪边界`,
      '贪狼': ` 您需要注意专注力的培养，避免三心二意。${genderPrefix}，要学会在多元发展中保持重点`,
      '巨门': ` 您需要注意表达方式的温和，避免过于直接。${genderPrefix}，要学会在坚持真理的同时照顾他人感受`,
      '天相': ` 您需要注意在帮助他人的同时也要为自己考虑。${genderPrefix}，要学会适当拒绝不合理要求`,
      '天梁': ` 您需要注意不要过于严肃而缺乏灵活性。${genderPrefix}，要学会在原则性和灵活性之间找到平衡`,
      '七杀': ` 您需要注意控制冲动，学会深思熟虑。${genderPrefix}，要学会在冲劲中保持理性`,
      '破军': ` 您需要注意在变化中保持稳定的核心价值。${genderPrefix}，要学会在创新中保持连续性`
    };
  ...
  getUnluckyStarsChallenge(unluckyStars, personName) {
    ...
    unluckyStars.forEach(star => {
      const starChallenge = {
        '擎羊': ` 擎羊星提醒您要控制冲动，学会耐心等待合适的时机`,
        '陀罗': ` 陀罗星提醒您要克服拖延，提高行动效率`,
        '火星': ` 火星提醒您要控制急躁情绪，学会冷静思考`,
        '铃星': ` 铃星提醒您要稳定情绪，避免过度波动`,
        '地空': ` 地空星提醒您要脚踏实地，避免好高骛远`,
        '地劫': ` 地劫星提醒您要谨慎理财，避免不必要的损失`
      };
  ...
  analyzePersonalizedPotential(mainStars, luckyStars, personGender, personName) {
    ...
    return potentials.join('；') || ` 您具有无限的发展潜力，关键在于如何发掘和运用`;
  }
  ...
  getStarPotential(star, personName, personGender) {
    ...
    const starPotentials = {
      '紫微': ` 您有成为杰出领导者的潜力。${genderPrefix}，您可以在管理、政治或大型组织中发挥重要作用`,
      '天机': ` 您有成为优秀策划师的潜力。${genderPrefix}，您可以在咨询、策划或智力密集型行业中获得成功`,
      '太阳': ` 您有成为公众人物的潜力。${genderPrefix}，您可以在教育、传媒或公共服务领域发光发热`,
      '武曲': ` 您有成为财务专家的潜力。${genderPrefix}，您可以在金融、投资或实业领域取得卓越成就`,
      '天同': ` 您有成为和谐使者的潜力。${genderPrefix}，您可以在服务、协调或人际关系领域发挥特长`,
      '廉贞': ` 您有成为艺术家的潜力。${genderPrefix}，您可以在艺术、设计或创意产业中展现才华`,
      '天府': ` 您有成为管理专家的潜力。${genderPrefix}，您可以在行政、管理或组织运营方面取得成功`,
      '太阴': ` 您有成为心理专家的潜力。${genderPrefix}，您可以在心理咨询、教育或照护行业中发挥专长`,
      '贪狼': ` 您有成为多元发展者的潜力。${genderPrefix}，您可以在多个领域同时发展，成为复合型人才`,
      '巨门': ` 您有成为专业分析师的潜力。${genderPrefix}，您可以在研究、分析或专业咨询领域获得认可`,
      '天相': ` 您有成为优秀助手的潜力。${genderPrefix}，您可以在辅助、支持或协调性工作中发挥重要作用`,
      '天梁': ` 您有成为人生导师的潜力。${genderPrefix}，您可以在教育、指导或公益事业中贡献力量`,
      '七杀': ` 您有成为开拓者的潜力。${genderPrefix}，您可以在创业、开拓或竞争性行业中取得突破`,
      '破军': ` 您有成为变革者的潜力。${genderPrefix}，您可以在创新、改革或新兴行业中引领潮流`
    };
  ...
  getLuckyStarsPotential(luckyStars, personName) {
    ...
    luckyStars.forEach(star => {
      const starPotential = {
        '文昌': ` 文昌星增强了您的学习和表达潜力，有望在文化教育领域取得成就`,
        '文曲': ` 文曲星提升了您的沟通和艺术潜力，有望在创意表达方面获得成功`,
        '左辅': ` 左辅星增强了您的团队合作潜力，有望在协作性工作中发挥重要作用`,
        '右弼': ` 右弼星提升了您的协调管理潜力，有望在组织管理方面取得成就`,
        '天魁': ` 天魁星增强了您获得贵人帮助的潜力，有望在关键时刻得到重要支持`,
        '天钺': ` 天钺星提升了您的直觉判断潜力，有望在需要洞察力的领域获得成功`
      };
  ...
  analyzePersonalizedLifeAttitude(mainStar, personGender, personName) {
    ...
    const lifeAttitudes = {
      '紫微': ` 您的人生态度是追求卓越和领导地位。${genderPrefix}，您相信通过努力和责任感可以实现人生价值，喜欢在团队中发挥核心作用`,
      '天机': ` 您的人生态度是追求智慧和变化。${genderPrefix}，您相信知识就是力量，喜欢通过学习和思考来解决问题`,
      '太阳': ` 您的人生态度是追求光明和正义。${genderPrefix}，您相信正直和热情可以感化他人，喜欢为他人带来希望和温暖`,
      '武曲': ` 您的人生态度是追求实际和成果。${genderPrefix}，您相信通过努力工作可以获得物质成功，注重实际效果和结果`,
      '天同': ` 您的人生态度是追求和谐和快乐。${genderPrefix}，您相信知足常乐，喜欢在平和的环境中享受生活`,
      '廉贞': ` 您的人生态度是追求美好和完美。${genderPrefix}，您相信生活应该充满美感，注重精神层面的满足`,
      '天府': ` 您的人生态度是追求稳定和积累。${genderPrefix}，您相信稳扎稳打可以获得长久成功，注重安全感和保障`,
      '太阴': ` 您的人生态度是追求内在和深度。${genderPrefix}，您相信内心的丰富比外在的繁华更重要，注重精神世界的建设`,
      '贪狼': ` 您的人生态度是追求多元和体验。${genderPrefix}，您相信人生应该丰富多彩，喜欢尝试不同的可能性`,
      '巨门': ` 您的人生态度是追求真理和深度。${genderPrefix}，您相信通过深入研究可以发现真相，注重专业性和权威性`,
      '天相': ` 您的人生态度是追求服务和奉献。${genderPrefix}，您相信帮助他人就是帮助自己，喜欢在服务中体现价值`,
      '天梁': ` 您的人生态度是追求正义和责任。${genderPrefix}，您相信每个人都有社会责任，喜欢为弱者发声和提供帮助`,
      '七杀': ` 您的人生态度是追求挑战和突破。${genderPrefix}，您相信只有在困难中才能成长，喜欢迎接各种挑战`,
      '破军': ` 您的人生态度是追求变革和创新。${genderPrefix}，您相信变化是进步的动力，喜欢在变化中寻找机会`
    };
    
    return lifeAttitudes[mainStar] || ` 您有着独特的人生态度和价值观，这是您最宝贵的财富`;
  }
  
  // 分析性格演化
  analyzePersonalityEvolution(mainStars, personName, personGender) {
    const evolution = ` 根据您的主星${mainStars.join('、')}，您的性格会随着人生阶段的变化而不断演化。青年时期您可能更多展现星曜的基本特质，中年时期会逐渐整合各种经验形成成熟的个性，晚年时期则会达到性格的升华和圆融。${personGender === '男性' ? '作为男性，您的性格演化会更多体现在责任感和成就感的提升上' : '作为女性，您的性格演化会更多体现在智慧和包容性的增长上'}。`;
  ...
  analyzeSocialInteractionStyle(mainStars, luckyStars, personName) {
    ...
    return ` 您的社交风格${baseStyle}。${luckyBonus}`;
  }
  ...
  analyzeDecisionMakingStyle(mainStars, personName, personGender) {
    ...
    return ` 您的决策风格${baseStyle}。${genderModifier}。`;
  }
  ...
  getLifePatternDescription(mainStar, personName) {
    const lifePatterns = {
      '紫微': ` 注定要承担重要责任，在人生的舞台上发挥领导作用`,
      '天机': ` 充满智慧和变化，人生路径多样且富有创意`,
      '太阳': ` 光明磊落，注定要照亮他人，成为正能量的源泉`,
      '武曲': ` 意志坚定，通过不懈努力必能获得物质成功`,
      '天同': ` 追求和谐快乐，人生注重精神层面的满足`,
      '廉贞': ` 感情丰富，人生充满艺术气息和美好追求`,
      '天府': ` 稳重可靠，人生注重积累和长远发展`,
      '太阴': ` 细腻敏感，人生重视内在修养和精神世界`,
      '贪狼': ` 多才多艺，人生充满各种可能性和机遇`,
      '巨门': ` 善于分析，人生注重专业发展和深度研究`,
      '天相': ` 忠诚可靠，人生价值在于服务他人和协调关系`,
      '天梁': ` 正直善良，人生使命是指导他人和维护正义`,
      '七杀': ` 勇于开拓，人生充满挑战和突破的机会`,
      '破军': ` 勇于创新，人生注定要在变革中寻找新的道路`
    };
    
    return lifePatterns[mainStar] || ` 拥有独特的人生格局和发展道路`;
  }
  ...
  getCareerStarCombinationAnalysis(careerStar, mingStar, personName) {
    const combinations = {
      '紫微': {
        '紫微': ` 具有天生的领导才能，适合在高层管理或政府部门发挥才华`,
        '天机': ` 结合了领导力和智慧，适合在策略规划或咨询行业发展`,
        '太阳': ` 具有强大的影响力和感召力，适合在公共事业或教育领域发光发热`,
        '武曲': ` 兼具领导力和执行力，适合在金融或实业领域取得成功`,
        '天同': ` 能够在和谐的环境中发挥领导作用，适合服务性行业的管理工作`
      },
      '天机': {
        '紫微': ` 智慧与权威并重，适合在智库或高端咨询领域发展`,
        '天机': ` 具有超强的分析和策划能力，适合在研究或策略规划领域发展`,
        '太阳': ` 智慧与正义并重，适合在法律或教育领域发挥专长`,
        '武曲': ` 理性分析与实际执行并重，适合在金融分析或项目管理领域`,
        '天同': ` 智慧与和谐并重，适合在人力资源或心理咨询领域发展`
      },
      '太阳': {
        '紫微': ` 光明与权威并重，适合在政府部门或大型企业的领导岗位`,
        '天机': ` 正义与智慧并重，适合在法律或新闻媒体领域发展`,
        '太阳': ` 具有强大的正能量和影响力，适合在教育或公益事业领域`,
        '武曲': ` 正直与执行力并重，适合在执法或军事领域发展`,
        '天同': ` 温暖与和谐并重，适合在社会服务或医疗健康领域`
      }
    };
    
    return combinations[careerStar]?.[mingStar] || ` 具有独特的事业发展潜力和优势`;
  }
  
  // 获取事业天赋描述
  getCareerTalentDescription(careerStar, personName) {
    const talents = {
      '紫微': ` 体现在组织领导和统筹规划方面，能够在复杂的环境中保持清晰的方向感`,
      '天机': ` 体现在分析思考和策略规划方面，善于发现问题的本质和解决方案`,
      '太阳': ` 体现在沟通表达和团队激励方面，能够用正能量影响和带动他人`,
      '武曲': ` 体现在执行实施和目标达成方面，具有很强的行动力和结果导向`,
      '天同': ` 体现在协调合作和服务他人方面，能够营造和谐的工作氛围`,
      '廉贞': ` 体现在创意设计和美学鉴赏方面，具有很强的艺术天赋和审美能力`,
      '天府': ` 体现在资源整合和财务管理方面，善于积累和配置各种资源`,
      '太阴': ` 体现在细致观察和深度分析方面，具有很强的洞察力和直觉`,
      '贪狼': ` 体现在多元发展和适应变化方面，能够在不同领域都有所建树`,
      '巨门': ` 体现在专业研究和深度分析方面，善于在专业领域建立权威`,
      '天相': ` 体现在辅助支持和协调配合方面，是团队中不可或缺的重要角色`,
      '天梁': ` 体现在指导培养和传承经验方面，具有很强的导师潜质`,
      '七杀': ` 体现在开拓创新和突破困难方面，勇于挑战和改变现状`,
      '破军': ` 体现在变革创新和重构优化方面，善于在变化中创造新的价值`
    };
    
    return talents[careerStar] || ` 具有独特的职业天赋和发展潜力`;
  }
  ...
  analyzeDeepCareerPotential(careerStars, mingGongStars, careerLucky, personName) {
    ...
    return potentials.join('；') || ` 您具有独特的事业发展潜力`;
  }
  
  // 获取事业宫主星潜力
  getCareerStarPotential(star, personName) {
    const potentials = {
      '紫微': ` 您有成为行业领袖的潜力，天生具备统领全局的能力，适合在大型组织中担任核心领导角色`,
      '天机': ` 您有成为智慧顾问的潜力，善于洞察趋势和分析问题，适合在咨询和策略规划领域发挥专长`,
      '太阳': ` 您有成为公众人物的潜力，具有很强的影响力和感召力，适合在需要公众曝光的领域发展`,
      '武曲': ` 您有成为实业家的潜力，具有很强的执行力和目标达成能力，适合在金融和实业领域创造价值`,
      '天同': ` 您有成为服务专家的潜力，善于营造和谐环境和服务他人，适合在服务性行业中发挥价值`,
      '廉贞': ` 您有成为创意大师的潜力，具有很强的艺术天赋和审美能力，适合在创意和设计领域发光发热`,
      '天府': ` 您有成为财富管理专家的潜力，善于积累和管理资源，适合在财务和投资领域取得成功`,
      '太阴': ` 您有成为深度分析师的潜力，具有很强的洞察力和直觉，适合在研究和分析领域建立权威`,
      '贪狼': ` 您有成为多元发展者的潜力，适应能力强且兴趣广泛，适合在多个领域同时发展`,
      '巨门': ` 您有成为专业权威的潜力，善于深入研究和专业分析，适合在专业技术领域建立地位`,
      '天相': ` 您有成为协调专家的潜力，善于辅助他人和协调关系，适合在支持性和协调性工作中发挥价值`,
      '天梁': ` 您有成为导师和指导者的潜力，具有很强的经验传承能力，适合在教育和培训领域发展`,
      '七杀': ` 您有成为开拓先锋的潜力，勇于挑战和突破，适合在需要开拓和创新的领域发挥才能`,
      '破军': ` 您有成为变革推动者的潜力，善于在变化中创造价值，适合在转型和创新领域发挥作用`
    };
  ...
  getMingGongCareerInfluence(star, personName) {
    const influences = {
      '紫微': ` 您的紫微命格为事业发展提供了天然的权威感和领导魅力，容易获得他人的认可和支持`,
      '天机': ` 您的天机命格为事业发展提供了敏锐的洞察力和分析能力，善于把握机会和趋势`,
      '太阳': ` 您的太阳命格为事业发展提供了正面的影响力和感召力，容易成为团队的核心和榜样`,
      '武曲': ` 您的武曲命格为事业发展提供了坚强的意志力和执行力，能够克服困难达成目标`,
      '天同': ` 您的天同命格为事业发展提供了和谐的人际关系和合作精神，容易获得团队支持`,
      '廉贞': ` 您的廉贞命格为事业发展提供了丰富的创意和美学素养，适合在创意领域发挥才华`,
      '天府': ` 您的天府命格为事业发展提供了稳健的管理能力和资源整合能力，善于积累和发展`,
      '太阴': ` 您的太阴命格为事业发展提供了细腻的观察力和深度思考能力，善于发现细节和本质`,
      '贪狼': ` 您的贪狼命格为事业发展提供了多元的兴趣和强大的适应能力，能够在变化中成长`,
      '巨门': ` 您的巨门命格为事业发展提供了深度的专业能力和分析思维，善于在专业领域建立权威`,
      '天相': ` 您的天相命格为事业发展提供了优秀的协调能力和服务精神，善于辅助他人成功`,
      '天梁': ` 您的天梁命格为事业发展提供了丰富的经验和指导能力，适合在教育和培养他人方面发挥价值`,
      '七杀': ` 您的七杀命格为事业发展提供了强大的开拓精神和挑战勇气，善于在困难中寻找突破`,
      '破军': ` 您的破军命格为事业发展提供了创新的思维和变革的勇气，善于在变化中创造新的机会`
    };
  ...
  getCareerLuckyStarsBonus(luckyStars, personName) {
    ...
    luckyStars.forEach(star => {
      const starBonus = {
        '文昌': ` 文昌星在事业宫的加持使您在文化、教育、写作等领域有特殊天赋，表达能力强，容易获得学术或文化方面的成就`,
        '文曲': ` 文曲星在事业宫的影响让您在沟通、艺术、创意等方面有独特优势，口才出众，适合需要表达和创意的工作`,
        '左辅': ` 左辅星在事业宫的帮助使您容易得到贵人相助和团队支持，在协作性工作中能发挥重要作用`,
        '右弼': ` 右弼星在事业宫的支持让您具有很强的协调管理能力，善于处理复杂的人际关系和工作事务`,
        '天魁': ` 天魁星在事业宫的庇佑使您容易遇到年长的贵人和导师，在关键时刻得到重要的指导和支持`,
        '天钺': ` 天钺星在事业宫的照耀让您具有很强的直觉判断力，能够在事业发展中把握关键机会和时机`
      };
   ...
   analyzePersonalizedIndustries(careerStars, mingGongStars, personName) {
     ...
     return industries.join('；') || ` 您适合多元化的行业发展`;
   }
   
   // 获取主星适合的行业
   getStarSuitableIndustries(star, personName) {
     const industries = {
       '紫微': ` 紫微星特质使您适合政府管理、大型企业高管、公共事业管理、组织领导等需要权威和统筹能力的行业`,
       '天机': ` 天机星特质使您适合战略咨询、市场研究、数据分析、智库顾问、策略规划等需要智慧和分析能力的行业`,
       '太阳': ` 太阳星特质使您适合教育培训、新闻媒体、公共关系、演艺娱乐、社会服务等需要影响力和表达能力的行业`,
       '武曲': ` 武曲星特质使您适合金融投资、项目管理、工程建设、制造业、执行实施等需要执行力和目标导向的行业`,
       '天同': ` 天同星特质使您适合人力资源、客户服务、社会工作、医疗健康、协调合作等需要和谐与服务精神的行业`,
       '廉贞': ` 廉贞星特质使您适合创意设计、艺术文化、时尚美容、品牌营销、美学相关等需要创意和审美能力的行业`,
       '天府': ` 天府星特质使您适合财务管理、银行保险、资产管理、投资理财、资源配置等需要管理和积累能力的行业`,
       '太阴': ` 太阴星特质使您适合心理咨询、深度研究、数据分析、市场洞察、精细服务等需要洞察力和细致观察的行业`,
       '贪狼': ` 贪狼星特质使您适合销售营销、跨界合作、创新业务、娱乐产业、多元发展等需要适应性和多元能力的行业`,
       '巨门': ` 巨门星特质使您适合专业研究、技术开发、学术研究、法律服务、专业咨询等需要专业深度和分析能力的行业`,
       '天相': ` 天相星特质使您适合行政管理、协调服务、后勤保障、辅助支持、团队协作等需要协调和服务能力的行业`,
       '天梁': ` 天梁星特质使您适合教育指导、培训发展、经验传承、咨询顾问、导师角色等需要指导和传承能力的行业`,
       '七杀': ` 七杀星特质使您适合创业开拓、市场拓展、销售业务、竞争性行业、挑战性工作等需要开拓精神和挑战勇气的行业`,
       '破军': ` 破军星特质使您适合变革创新、重构优化、新兴行业、转型升级、创新科技等需要变革思维和创新能力的行业`
     };
   ...
   getMingGongIndustryInfluence(star, personName) {
     const influences = {
       '紫微': ` 您的紫微命格增强了在权威性和领导性行业中的发展优势，容易在大型组织中获得认可`,
       '天机': ` 您的天机命格增强了在智力密集型和策略性行业中的发展优势，善于把握行业趋势和机会`,
       '太阳': ` 您的太阳命格增强了在公众性和影响力行业中的发展优势，容易在需要曝光度的行业中成功`,
       '武曲': ` 您的武曲命格增强了在实业和金融行业中的发展优势，具有很强的目标达成和执行能力`,
       '天同': ` 您的天同命格增强了在服务性和协调性行业中的发展优势，能够在和谐的环境中发挥最大价值`,
       '廉贞': ` 您的廉贞命格增强了在创意和美学行业中的发展优势，具有独特的艺术天赋和审美能力`,
       '天府': ` 您的天府命格增强了在管理和财务行业中的发展优势，善于资源整合和长期规划`,
       '太阴': ` 您的太阴命格增强了在研究和分析行业中的发展优势，具有深度思考和洞察的能力`,
       '贪狼': ` 您的贪狼命格增强了在多元和创新行业中的发展优势，能够在变化中找到新的机会`,
       '巨门': ` 您的巨门命格增强了在专业和技术行业中的发展优势，善于在专业领域建立权威地位`,
       '天相': ` 您的天相命格增强了在协调和支持行业中的发展优势，是团队中不可或缺的重要角色`,
       '天梁': ` 您的天梁命格增强了在教育和指导行业中的发展优势，具有很强的经验传承和培养能力`,
       '七杀': ` 您的七杀命格增强了在开拓和竞争行业中的发展优势，勇于在困难中寻找突破机会`,
       '破军': ` 您的破军命格增强了在变革和创新行业中的发展优势，善于在变化中创造新的价值`
     };
    ...
    analyzePersonalizedLeadershipStyle(mingGongStars, careerStars, personName) {
      ...
      return styles.join('；') || ` 您具有独特的领导风格和管理特质`;
    }
    
    // 获取命宫主星的领导风格
    getMingGongLeadershipStyle(star, personName) {
      const styles = {
        '紫微': ` 您的紫微命格赋予您天生的权威感和统领能力，领导风格威严而有魅力，善于制定宏观战略和长远规划`,
        '天机': ` 您的天机命格使您成为智慧型领导者，善于分析和策划，领导风格灵活机智，能够在复杂情况下找到最佳解决方案`,
        '太阳': ` 您的太阳命格让您成为光明正大的领导者，领导风格开放透明，善于激励团队，能够用正能量影响和带动他人`,
        '武曲': ` 您的武曲命格造就了您执行力强的领导风格，注重结果导向，善于制定明确目标并推动团队达成`,
        '天同': ` 您的天同命格使您成为和谐型领导者，领导风格温和包容，善于营造良好的团队氛围和人际关系`,
        '廉贞': ` 您的廉贞命格赋予您创新型的领导风格，富有创意和美感，善于激发团队的创造力和艺术潜能`,
        '天府': ` 您的天府命格让您成为稳健型领导者，领导风格务实可靠，善于资源整合和团队建设`,
        '太阴': ` 您的太阴命格使您成为细致入微的领导者，领导风格深思熟虑，善于观察和洞察团队成员的需求`,
        '贪狼': ` 您的贪狼命格造就了您适应性强的领导风格，能够在不同环境中调整管理方式，善于激发团队活力`,
        '巨门': ` 您的巨门命格使您成为专业型领导者，领导风格严谨专业，善于在专业领域建立权威和标准`,
        '天相': ` 您的天相命格赋予您协调型的领导风格，善于平衡各方利益，是团队中的重要协调者和支持者`,
        '天梁': ` 您的天梁命格让您成为导师型领导者，领导风格富有经验和智慧，善于指导和培养团队成员`,
        '七杀': ` 您的七杀命格造就了您开拓型的领导风格，勇于挑战和突破，善于带领团队在困难中寻找机会`,
        '破军': ` 您的破军命格使您成为变革型领导者，领导风格创新进取，善于在变化中带领团队创造新的价值`
      };
    ...
    getCareerStarLeadershipStyle(star, personName) {
      const styles = {
        '紫微': ` 事业宫紫微星增强了您的组织统筹能力，在工作中展现出卓越的领导魅力和决策能力`,
        '天机': ` 事业宫天机星增强了您的策略思维能力，在工作中善于制定智慧的计划和灵活的应对策略`,
        '太阳': ` 事业宫太阳星增强了您的影响力和感召力，在工作中能够成为团队的精神领袖和榜样`,
        '武曲': ` 事业宫武曲星增强了您的执行力和目标达成能力，在工作中展现出强大的行动力和结果导向`,
        '天同': ` 事业宫天同星增强了您的协调合作能力，在工作中善于营造和谐的团队氛围`,
        '廉贞': ` 事业宫廉贞星增强了您的创意领导能力，在工作中能够激发团队的创新思维和美学追求`,
        '天府': ` 事业宫天府星增强了您的管理统筹能力，在工作中善于整合资源和建立稳固的团队基础`,
        '太阴': ` 事业宫太阴星增强了您的洞察分析能力，在工作中善于发现问题的本质和团队的潜在需求`,
        '贪狼': ` 事业宫贪狼星增强了您的多元领导能力，在工作中能够适应不同的团队和环境需求`,
        '巨门': ` 事业宫巨门星增强了您的专业权威能力，在工作中能够在专业领域建立领导地位`,
        '天相': ` 事业宫天相星增强了您的辅助协调能力，在工作中是团队中不可或缺的重要支持者`,
        '天梁': ` 事业宫天梁星增强了您的指导培养能力，在工作中善于传承经验和培养下属`,
        '七杀': ` 事业宫七杀星增强了您的开拓进取能力，在工作中勇于承担挑战和开创新的局面`,
        '破军': ` 事业宫破军星增强了您的变革创新能力，在工作中善于推动变革和创造新的工作模式`
      };
    ...
    analyzePersonalizedCareerDevelopment(careerStars, careerStrength, personName) {
      ...
      return developments.join('；') || ` 您的事业发展具有独特的路径和机会`;
    }
    
    // 获取主星的事业发展路径
    getStarCareerDevelopment(star, personName) {
      const developments = {
        '紫微': ` 您的事业发展适合从基层管理开始，逐步向高层领导发展，最终成为行业或组织的核心决策者`,
        '天机': ` 您的事业发展适合从专业分析师开始，逐步向战略顾问发展，最终成为智慧型的行业专家`,
        '太阳': ` 您的事业发展适合从公众服务开始，逐步扩大影响力，最终成为具有社会影响力的公众人物`,
        '武曲': ` 您的事业发展适合从执行岗位开始，逐步向项目管理发展，最终成为实业领域的成功企业家`,
        '天同': ` 您的事业发展适合从服务岗位开始，逐步向团队协调发展，最终成为和谐型的管理专家`,
        '廉贞': ` 您的事业发展适合从创意工作开始，逐步向艺术管理发展，最终成为创意产业的领军人物`,
        '天府': ` 您的事业发展适合从财务管理开始，逐步向资源整合发展，最终成为财富管理的专业人士`,
        '太阴': ` 您的事业发展适合从研究分析开始，逐步向深度咨询发展，最终成为洞察力强的行业智者`,
        '贪狼': ` 您的事业发展适合从多元尝试开始，逐步找到最适合的领域，最终成为跨界发展的成功人士`,
        '巨门': ` 您的事业发展适合从专业技术开始，逐步向专业权威发展，最终成为行业内的技术专家`,
        '天相': ` 您的事业发展适合从辅助工作开始，逐步向协调管理发展，最终成为团队中的重要支柱`,
        '天梁': ` 您的事业发展适合从经验积累开始，逐步向指导培训发展，最终成为行业内的导师级人物`,
        '七杀': ` 您的事业发展适合从挑战性工作开始，逐步向开拓创新发展，最终成为行业的开拓先锋`,
        '破军': ` 您的事业发展适合从变革项目开始，逐步向创新领导发展，最终成为行业变革的推动者`
      };
    ...
    getCareerStrengthAdvice(strength, personName) {
      if (strength === 'strong') {
        return ` 您的事业宫力量强劲，事业发展顺利，建议积极进取，把握机会快速发展`;
      } else if (strength === 'medium') {
        return ` 您的事业宫力量适中，事业发展稳定，建议稳扎稳打，注重积累和提升`;
      } else {
        return ` 您的事业宫需要加强，建议通过学习提升和人脉建设来增强事业发展动力`;
      }
    }
    ...
    analyzeDetailedCareerPeakPeriods(majorPeriods, careerStars, personName) {
      ...
      return periods.join('；') || ` 您的事业发展将在不同阶段展现不同的特色和机会`;
    }
    ...
    getCareerPeriodAnalysis(period, careerStars, personName, index) {
      ...
      const periodAdvice = {
        0: ` 在${ageRange}期间，这是您事业的起步阶段，建议专注于基础技能的学习和积累`,
        1: ` 在${ageRange}期间，这是您事业的成长阶段，${mainCareerStar}星的特质将开始显现，建议积极拓展专业领域`,
        2: ` 在${ageRange}期间，这是您事业的发展阶段，建议把握机会，在专业领域建立自己的地位`,
        3: ` 在${ageRange}期间，这是您事业的成熟阶段，建议发挥领导才能，承担更大的责任`,
        4: ` 在${ageRange}期间，这是您事业的巅峰阶段，建议充分发挥${mainCareerStar}星的优势，实现事业目标`,
        5: ` 在${ageRange}期间，这是您事业的传承阶段，建议将经验和智慧传授给后辈，建立持久的影响力`
      };
      
      return periodAdvice[index] || ` 在${ageRange}期间，您的事业发展将有独特的机会和挑战`;
    }
  ...
  analyzeCareerChallenges(careerUnlucky, careerStars, personName) {
    ...
    return challenges.length > 0 ? challenges.join('；') : ` 您的事业发展相对顺利，主要挑战来自于如何更好地发挥自身优势`;
  }
  ...
  generateCareerSuccessStrategies(careerStars, mingGongStars, personName) {
    ...
    careerStars.forEach(star => {
      const starStrategies = {
        '紫微': ` 紫微星事业成功策略：1) 培养领导魅力，提升个人影响力；2) 主动承担重要项目和责任；3) 建立权威专业形象；4) 发展战略思维，从全局角度思考问题；5) 建立高层次的人脉网络；6) 注重个人品牌建设。`,
        '天机': ` 天机星事业成功策略：1) 持续学习新知识和技能；2) 发挥分析和策划优势；3) 把握行业发展趋势和机会；4) 培养创新思维和解决问题的能力；5) 建立智囊团队，集思广益；6) 注重信息收集和分析。`,
        '太阳': ` 太阳星事业成功策略：1) 建立正面积极的职业形象；2) 主动帮助同事和下属成长；3) 发挥影响力和感召力；4) 参与公益活动，提升社会声誉；5) 在团队中发挥核心作用；6) 注重道德品格和职业操守。`,
        '武曲': ` 武曲星事业成功策略：1) 注重实际成果和业绩表现；2) 持续提升专业技能和执行力；3) 设定明确的目标并坚持执行；4) 培养财务管理和成本控制能力；5) 在实业领域深耕发展；6) 建立可量化的成功指标。`,
        '天同': ` 天同星事业成功策略：1) 营造和谐的工作氛围；2) 发挥团队协调和沟通能力；3) 建立良好的人际关系网络；4) 在服务性行业发挥优势；5) 注重工作与生活的平衡；6) 培养包容和理解的领导风格。`,
        '廉贞': ` 廉贞星事业成功策略：1) 发挥创意和艺术天赋；2) 注重工作的美感和品质；3) 在创意产业中寻找机会；4) 培养审美能力和设计思维；5) 建立个人风格和特色；6) 平衡理性分析与感性创作。`,
        '天府': ` 天府星事业成功策略：1) 采用稳健的发展策略；2) 注重资源积累和管理；3) 建立可靠的业务基础；4) 发挥财务管理和投资能力；5) 在传统行业中寻找机会；6) 培养长期规划和风险控制能力。`,
        '太阴': ` 太阴星事业成功策略：1) 发挥细致入微的观察力；2) 在幕后支持和辅助角色中发光；3) 培养深度分析和研究能力；4) 注重细节和质量控制；5) 建立专业的技术能力；6) 在需要耐心和细心的领域发展。`,
        '贪狼': ` 贪狼星事业成功策略：1) 保持多元化发展思路；2) 善于学习和适应新环境；3) 抓住各种发展机会；4) 培养销售和市场开拓能力；5) 建立广泛的社交网络；6) 保持对新趋势的敏感度。`,
        '巨门': ` 巨门星事业成功策略：1) 深入专业领域，建立权威地位；2) 发挥分析和研究优势；3) 培养专业咨询和指导能力；4) 注重知识积累和经验总结；5) 在需要专业判断的领域发展；6) 建立专业声誉和口碑。`,
        '天相': ` 天相星事业成功策略：1) 发挥协调和服务能力；2) 在团队中扮演重要支撑角色；3) 培养忠诚可靠的职业品格；4) 建立信任和合作关系；5) 在需要协调配合的岗位发光；6) 注重职业道德和责任感。`,
        '天梁': ` 天梁星事业成功策略：1) 发挥指导和教育作用；2) 承担社会责任和使命；3) 建立正面的影响力；4) 培养长者风范和智慧；5) 在教育培训领域发展；6) 注重品德修养和人格魅力。`,
        '七杀': ` 七杀星事业成功策略：1) 勇于接受挑战和开拓新领域；2) 在竞争激烈的环境中脱颖而出；3) 培养果断的决策能力；4) 敢于承担风险和责任；5) 在需要突破的项目中发挥作用；6) 建立强大的执行力和行动力。`,
        '破军': ` 破军星事业成功策略：1) 勇于创新和推动变革；2) 在变化中寻找新机会；3) 培养颠覆性思维；4) 敢于打破传统模式；5) 在新兴行业中寻找发展空间；6) 保持对变化的适应能力。`
      };
  ...
  generateNetworkingGuidance(careerStars, careerLucky, personName) {
    ...
    return guidance.length > 0 ? guidance.join('；') : ` 建议主动参与行业活动，真诚待人，建立长期的合作关系`;
  }
  ...
  analyzeCareerTransformation(careerStars, majorPeriods, personName) {
    ...
    return transformations.length > 0 ? transformations.join('；') : ` 您的事业转型应该根据个人兴趣和市场需求来规划`;
  }
  ...
  generateModernCareerAdvice(careerStars, mingGongStars, personName) {
    ...
    careerStars.forEach(star => {
      const modernAdvice = {
        '紫微': ` 紫微星现代事业发展建议：1) 适合创业或担任CEO、总裁等高级管理职位；2) 可考虑数字化转型、企业咨询、投资管理等领域；3) 发展个人IP和影响力，成为行业意见领袖；4) 关注ESG投资、可持续发展等前沿领域；5) 利用社交媒体建立个人品牌；6) 考虑跨界合作和资源整合。`,
        '天机': ` 天机星现代事业发展建议：1) 适合从事大数据分析、人工智能、战略咨询等工作；2) 可发展为数据科学家、产品经理、商业分析师；3) 关注新兴技术趋势，如区块链、物联网等；4) 培养跨学科知识，成为复合型人才；5) 参与创新项目和研发工作；6) 建立技术专家的个人品牌。`,
        '太阳': ` 太阳星现代事业发展建议：1) 适合从事新媒体运营、内容创作、公共关系等工作；2) 可发展为KOL、教育培训师、企业文化官；3) 利用短视频、直播等平台扩大影响力；4) 关注社会责任和公益事业；5) 发展个人教育品牌和课程；6) 在ESG和可持续发展领域发挥作用。`,
        '武曲': ` 武曲星现代事业发展建议：1) 适合从事金融科技、项目管理、供应链管理等工作；2) 可发展为产品经理、运营总监、风控专家；3) 关注数字货币、区块链金融等新兴领域；4) 培养数据分析和风险管理能力；5) 在制造业数字化转型中发挥作用；6) 发展量化投资和智能理财技能。`,
        '天同': ` 天同星现代事业发展建议：1) 适合从事用户体验设计、客户成功管理、团队协作工具开发等工作；2) 可发展为UX设计师、社区运营、企业文化建设者；3) 关注远程办公和协作工具的发展；4) 培养跨文化沟通和团队管理能力；5) 在健康科技和心理健康领域发展；6) 发展情商和软技能培训业务。`,
        '廉贞': ` 廉贞星现代事业发展建议：1) 适合从事UI/UX设计、创意策划、时尚科技等工作；2) 可发展为创意总监、品牌设计师、数字艺术家；3) 关注AR/VR、数字艺术、NFT等新兴创意领域；4) 培养跨媒体创作和数字化设计能力；5) 在美妆科技、时尚电商等领域发展；6) 建立个人创意品牌和作品集。`,
        '天府': ` 天府星现代事业发展建议：1) 适合从事财务科技、资产管理、企业服务等工作；2) 可发展为财务总监、投资顾问、企业服务专家；3) 关注智能财务、自动化会计等技术应用；4) 培养数字化财务管理和投资分析能力；5) 在保险科技、财富管理等领域发展；6) 发展稳健投资和风险管理专长。`,
        '太阴': ` 太阴星现代事业发展建议：1) 适合从事数据分析、用户研究、质量管理等工作；2) 可发展为数据分析师、用户体验研究员、质量工程师；3) 关注机器学习、深度学习等技术应用；4) 培养精细化运营和数据挖掘能力；5) 在医疗科技、教育科技等需要细致分析的领域发展；6) 发展专业研究和咨询能力。`,
        '贪狼': ` 贪狼星现代事业发展建议：1) 适合从事电商运营、社交媒体营销、跨境贸易等工作；2) 可发展为增长黑客、社交电商专家、国际业务拓展；3) 关注直播带货、社群营销等新兴商业模式；4) 培养多平台运营和国际化视野；5) 在新零售、共享经济等领域发展；6) 发展个人IP和多元化收入来源。`,
        '巨门': ` 巨门星现代事业发展建议：1) 适合从事法律科技、医疗信息化、专业咨询等工作；2) 可发展为合规专家、医疗数据分析师、行业研究员；3) 关注人工智能在专业服务中的应用；4) 培养深度专业知识和跨领域整合能力；5) 在监管科技、精准医疗等领域发展；6) 建立专业权威和知识付费品牌。`,
        '天相': ` 天相星现代事业发展建议：1) 适合从事客户成功管理、供应链协调、平台运营等工作；2) 可发展为客户成功经理、供应链专家、平台生态建设者；3) 关注B2B服务、企业协作平台等领域；4) 培养跨部门协调和生态建设能力；5) 在SaaS服务、企业数字化等领域发展；6) 发展服务设计和流程优化专长。`,
        '天梁': ` 天梁星现代事业发展建议：1) 适合从事在线教育、知识付费、企业培训等工作；2) 可发展为在线教育专家、企业教练、知识博主；3) 关注AI教育、个性化学习等技术应用；4) 培养内容创作和教学设计能力；5) 在职业教育、终身学习等领域发展；6) 建立教育品牌和课程体系。`,
        '七杀': ` 七杀星现代事业发展建议：1) 适合从事创业投资、业务拓展、竞争分析等工作；2) 可发展为创业者、投资经理、市场开拓专家；3) 关注新兴市场、颠覆性创新等机会；4) 培养敏锐的市场嗅觉和快速决策能力；5) 在共享经济、新能源等竞争激烈领域发展；6) 发展风险投资和创业孵化能力。`,
        '破军': ` 破军星现代事业发展建议：1) 适合从事产品创新、技术研发、商业模式设计等工作；2) 可发展为产品创新专家、技术架构师、商业模式设计师；3) 关注前沿科技、颠覆性技术等领域；4) 培养创新思维和快速迭代能力；5) 在人工智能、生物科技等前沿领域发展；6) 发展技术创新和商业变革能力。`
      };
    ...
    return (advice.length > 0 ? advice.join('\n\n') : ` 建议根据个人兴趣和市场趋势选择适合的现代职业发展方向`) + generalModernAdvice;
  }
  ...
  generatePersonalizedWealthOverview(personName, wealthStars, mainStar, wealthPosition) {
    ...
    return ` 您的财帛宫位于${wealthPosition}，主星为${starCombination}。${positionInfluence}这样的星曜配置使您在财富积累方面${this.getWealthStarCombinationAnalysis(wealthStars, personName)}。您的财富格局${this.getWealthPatternDescription(mainStar, personName)}。`;
  }
  ...
  getWealthPatternDescription(mainStar, personName) {
    const patterns = {
      '紫微': ` 注定要通过领导和管理获得丰厚财富`,
      '天机': ` 智慧是您最大的财富，善用策略必能致富`,
      '太阳': ` 光明正大的财富之路，帮助他人也能成就自己`,
      '武曲': ` 实干致富，通过努力工作必能获得丰厚回报`,
      '天同': ` 平稳致富，财富增长虽缓但持续稳定`,
      '廉贞': ` 品味致富，通过美感和创意获得财富`,
      '天府': ` 积累致富，善于储蓄和投资的理财高手`,
      '太阴': ` 细水长流，通过精细管理获得稳定财富`,
      '贪狼': ` 多元致富，财富来源广泛且机会众多`,
      '巨门': ` 专业致富，通过深度专业技能获得高收入`,
      '天相': ` 服务致富，通过帮助他人获得相应回报`,
      '天梁': ` 正道致富，财富来源正当且受人尊敬`,
      '七杀': ` 拼搏致富，敢于冒险必能获得丰厚回报`,
      '破军': ` 创新致富，通过变革和创新开辟财富新路`
    };
    
    return patterns[mainStar] || ` 拥有独特的财富发展格局`;
  }
  ...
  analyzeDeepWealthPotential(wealthStars, wealthLucky, wealthUnlucky, personName) {
    ...
    return potentials.length > 0 ? potentials.join('；') : ` 您有独特的财富发展潜力`;
  }
  ...
  analyzePersonalizedEarningStyle(wealthStars, mainStar, personName) {
    ...
    return styles.length > 0 ? styles.join('；') : ` 您有独特的赚钱风格`;
  }
  ...
  analyzePersonalizedInvestmentTendency(wealthStars, mingGongStars, personName) {
    ...
    return tendencies.length > 0 ? tendencies.join('；') : ` 您有独特的投资倾向`;
  }
  ...
  analyzePersonalizedFinancialManagement(wealthStars, wealthStrength, personName) {
    ...
    return management.length > 0 ? management.join('；') : ` 您有独特的财务管理风格`;
  }

  // 分析详细财富时机
  analyzeDetailedWealthTiming(wealthStars, wealthLucky, personName) {
    return ` 根据您的财帛宫星曜配置，建议在事业稳定后开始大规模投资，把握市场机会的同时注重风险控制。`;
  }
  ...
  analyzeWealthObstacles(wealthUnlucky, wealthStars, personName) {
    ...
    return obstacles.length > 0 ? obstacles.join('；') : ` 您的财富发展相对顺利，主要注意合理规划即可`;
  }
  ...
  analyzeWealthOpportunities(wealthStars, wealthLucky, personName) {
    ...
    return opportunities.length > 0 ? opportunities.join('；') : ` 建议主动寻找合适的投资机会，发挥自身优势`;
  }

  // 分析被动收入机会
  analyzePassiveIncomeOpportunities(wealthStars, mingGongStars, personName) {
    return ` 根据您的星曜特质，建议考虑通过投资理财、知识产权、租赁收入等方式建立被动收入来源。`;
  }
  ...
  generateFinancialPlanningAdvice(wealthStars, mainStar, personName) {
    ...
    // 根据主星特质给出具体理财建议
    const starAdvice = {
      '紫微': ` 建议采用贵族式理财策略：1) 投资高端理财产品和蓝筹股；2) 建立多元化投资组合，包括股票、债券、房地产；3) 寻求专业理财顾问的建议；4) 注重长期价值投资，避免短期投机。`,
      '天机': ` 建议采用智慧型理财策略：1) 深入研究投资标的，做好功课再投资；2) 关注科技股和成长型企业；3) 利用量化分析工具辅助决策；4) 定期调整投资组合，灵活应对市场变化。`,
      '太阳': ` 建议采用阳光透明理财策略：1) 选择知名度高、透明度好的投资产品；2) 投资ESG概念股票和绿色债券；3) 参与公开透明的投资平台；4) 避免复杂的金融衍生品，坚持简单明了的投资方式。`,
      '武曲': ` 建议采用实战型理财策略：1) 重点投资实业股票和REITs；2) 建立应急基金，确保财务安全；3) 采用定投策略，持续积累财富；4) 关注投资回报率，追求实际收益。`,
      '天同': ` 建议采用和谐稳健理财策略：1) 选择风险适中的平衡型基金；2) 分散投资，不把鸡蛋放在一个篮子里；3) 与家人共同制定理财计划；4) 注重投资的稳定性和可持续性。`,
      '廉贞': ` 建议采用品味型理财策略：1) 投资艺术品、收藏品等另类资产；2) 关注奢侈品牌和时尚产业股票；3) 选择有美学价值的投资标的；4) 平衡理性投资与感性偏好。`,
      '天府': ` 建议采用稳健积累理财策略：1) 优先建立充足的储蓄基金；2) 投资稳定分红的蓝筹股；3) 考虑购买保险和年金产品；4) 制定长期财富积累计划，注重复利效应。`,
      '太阴': ` 建议采用细致入微理财策略：1) 详细记录每笔收支，做好财务规划；2) 选择稳健的债券和货币基金；3) 关注细分行业的投资机会；4) 定期评估和调整投资组合。`,
      '贪狼': ` 建议采用多元化理财策略：1) 投资多个不同行业和地区；2) 尝试新兴投资工具，如数字货币、P2P等；3) 保持一定比例的高风险高收益投资；4) 灵活调整投资策略，把握市场机会。`,
      '巨门': ` 建议采用专业深度理财策略：1) 专注于自己熟悉的行业进行投资；2) 深入研究投资标的的基本面；3) 寻求专业的投资建议和分析报告；4) 建立自己的投资评估体系。`,
      '天相': ` 建议采用协调平衡理财策略：1) 在风险和收益之间寻找平衡点；2) 选择信誉良好的金融机构；3) 与专业理财师合作制定投资计划；4) 注重投资的社会责任和道德标准。`,
      '天梁': ` 建议采用稳重长远理财策略：1) 制定长期投资计划，坚持价值投资；2) 选择有社会价值的投资标的；3) 建立教育基金和养老基金；4) 传承财富管理经验给下一代。`,
      '七杀': ` 建议采用进取型理财策略：1) 适当配置高风险高收益的投资产品；2) 关注新兴市场和成长股；3) 敢于在市场低迷时逆向投资；4) 设定明确的投资目标和止损点。`,
      '破军': ` 建议采用创新突破理财策略：1) 关注颠覆性技术和新兴产业；2) 投资创新型企业和独角兽公司；3) 尝试新的投资模式和工具；4) 保持对市场变化的敏感度，及时调整策略。`
    };
    
    // 通用理财建议
    const generalAdvice = `\n\n通用理财原则：\n1. 建立紧急备用金（3-6个月生活费）\n2. 根据年龄调整风险偏好（100-年龄=股票配置比例）\n3. 定期定额投资，利用时间复利效应\n4. 分散投资风险，不要过度集中\n5. 持续学习理财知识，提升财商\n6. 定期检视投资组合，适时调整\n7. 控制投资成本，选择低费率产品\n8. 保持理性，避免情绪化投资决策`;
    
    return (starAdvice[mainStar] || ` 建议制定适合自己的理财规划，合理配置资产，在保证安全的前提下追求稳健增长。`) + generalAdvice;
  }

  // 生成现代财富策略
  generateModernWealthStrategies(wealthStars, mingGongStars, personName) {
    return ` 在数字化时代，建议关注科技投资、数字资产、在线教育等新兴领域的投资机会。`;
  }

  // 分析财务风险管理
  analyzeFinancialRiskManagement(wealthStars, wealthUnlucky, personName) {
    return ` 建议建立应急基金，分散投资风险，定期评估投资组合，确保财务安全。`;
  }
  ...
  generatePersonalizedRelationshipOverview(personName, marriageStars, personGender, marriagePosition) {
    ...
    return ` 您的夫妻宫位于${marriagePosition}，主星为${starCombination}。${positionInfluence}这样的星曜配置使您在感情关系中${this.getMarriageStarCombinationAnalysis(marriageStars, personName)}，${genderModifier}。您的感情格局${this.getMarriagePatternDescription(marriageStars[0] || '天机', personName)}。`;
  }
  ...
  getMarriagePatternDescription(mainStar, personName) {
    const patterns = {
      '紫微': ` 注定要在感情中扮演重要角色，建立高品质的关系`,
      '天机': ` 智慧是您感情的基础，善于经营精神层面的爱情`,
      '太阳': ` 光明正大的感情观，真诚待人必能获得真爱`,
      '武曲': ` 实际的感情观，通过行动表达爱意`,
      '天同': ` 和谐的感情观，追求心灵的契合与平静`,
      '廉贞': ` 浪漫的感情观，重视美感和激情`,
      '天府': ` 稳定的感情观，善于建立长久的关系`,
      '太阴': ` 细腻的感情观，重视内心的交流与理解`,
      '贪狼': ` 多元的感情观，感情生活丰富多彩`,
      '巨门': ` 深度的感情观，重视沟通和理解`,
      '天相': ` 忠诚的感情观，重视承诺和责任`,
      '天梁': ` 成熟的感情观，善于指导和保护`,
  ...
  generatePersonalizedLifeOverview(personName, mainStar, mingGong, patternAnalysis) {
    ...
    return ` 您的人生以${starCombination}为主导，${this.getLifeOverviewDescription(mainStar, personName)}。您的人生格局${this.getLifePatternOverview(patternAnalysis, personName)}，注定要在人生的道路上发挥独特的作用和价值。`;
  }

  // 获取人生概述描述
  getLifeOverviewDescription(mainStar, personName) {
    const descriptions = {
      '紫微': ` 您天生具有领导者的气质，注定要在人生中承担重要责任`,
      '天机': ` 您拥有智慧和策略思维，善于规划和指导人生方向`,
      '太阳': ` 您具有光明正大的品格，人生使命是照亮和帮助他人`,
      '武曲': ` 您拥有坚强的意志力，通过实干和努力创造人生价值`,
      '天同': ` 您追求和谐快乐的人生，重视精神层面的满足`,
      '廉贞': ` 您具有丰富的情感和艺术天赋，人生充满美感和创意`,
      '天府': ` 您善于积累和管理，人生注重稳健发展和长远规划`,
      '太阴': ` 您细腻敏感，善于照顾他人，人生价值在于默默奉献`,
      '贪狼': ` 您多才多艺，人生充满各种可能性和机遇`,
      '巨门': ` 您善于分析和研究，人生注重专业发展和深度探索`,
      '天相': ` 您忠诚可靠，人生价值在于服务他人和协调关系`,
      '天梁': ` 您正直善良，人生使命是指导他人和维护正义`,
      '七杀': ` 您勇于开拓，人生充满挑战和突破的机会`,
      '破军': ` 您勇于创新，人生注定要在变革中寻找新的道路`
    };
    
    return descriptions[mainStar] || ` 您拥有独特的人生使命和发展道路`;
  }
